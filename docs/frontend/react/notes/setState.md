...
所以这道题回到问题本身上来，其实思路很简单，只要能说清楚什么是同步场景，什么是异步场景，那问题自然而然就解决了。
...
![React 17 之前的事件冒泡流程图](../imgs/react17.png)
...
![React 17 后的事件冒泡流程图](../imgs/react17_after.png)
...
1. **保持内部一致性**。如果改为同步更新方式，尽管 setState 变成了同步，但是 props 不是。
